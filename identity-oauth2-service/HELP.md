...
* The original package name 'com.indentity-oauth2' is invalid and this project uses 'com.indentity_oauth2' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/docs/3.2.10/reference/htmlsingle/index.html#web.security.oauth2.server)
